    ...
    <>
      <style jsx>{`
        ...
        .tab-btn.active {
          ...
          color: #fff;
          box-shadow: 0 2px 8px rgba(232, 56, 109, 0.3);
        }
          ...
          {tab === 'join' && (
            ...
            >
              ...
              >
                ...
                >
                  Inseriscilo qui sotto per entrare nella stanza del tuo
                  partner
                </div>
              </div>
              ...
              >
                Il tuo partner vede il codice nella schermata della sua
                stanza
              </div>
            </form>
          )}
            ...
            <>
              ...
              {mode && (
                ...
                >
                  ...
                  <div>
                    {mode === 'trending' &&
                      'I 20 film più popolari di questa settimana'}

                    {mode === 'cinema' &&
                      'Film attualmente nelle sale italiane'}

                    {mode === 'streaming' &&
                      'Film disponibili su Netflix, Prime, Disney+ e altri in Italia'}

                    {mode === 'discover' &&
                      'Scegli genere e anno nel passo successivo'}
                  </div>
                </div>
              )}
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) => {
                        ...
                        if (
                          parseInt(e.target.value) < yearFrom
                        ) {
                          setYearError(
                            'L\'anno "al" non può essere minore dell\'anno "dal"'
                          );
                        }
                      }}
                      onBlur={validateYears}
